...
const TaskItem = ({ item, navigation, toggleTaskCompletion, deleteTask }) => {
  return (
    <View style={styles.taskItem}>
      <Button
        buttonStyle={{ backgroundColor: item.completed? Colors.taskCompleted : Colors.taskPending, marginRight: 10}}
      ...
      <Button
        buttonStyle={{ backgroundColor: Colors.taskDelete, marginLeft: 10 }}
